...
@if($it->Factura_PDF)
<a href="{{ asset('storage/'.$it->Factura_PDF) }}"
   target="_blank"
...
@endif
        ...
        <td class="sticky right-0 z-40 bg-[#0f172a] border-l border-[rgba(212,175,55,.18)] p-0">
            <div class="actions-wrapper h-full py-3">
                ...
                <!-- VER -->
                <a href="{{ route('computo.publico', $it->id) }}"
                   target="_blank"
                ...
                <!-- EDITAR -->
                <a href="{{ route('computo.edit', $it->id) }}"
                ...
                <!-- ELIMINAR -->
                <form method="POST"
                      action="{{ route('computo.destroy', $it->id) }}"
