...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared('
            CREATE TRIGGER calcular_moi_total_insert_maquinaria_equipo
            BEFORE INSERT ON maquinaria_equipo
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared('
            CREATE TRIGGER calcular_moi_total_update_maquinaria_equipo
            BEFORE UPDATE ON maquinaria_equipo
            FOR EACH ROW
            BEGIN
                SET NEW.MOI_Total = IFNULL(NEW.MOI,0) * IFNULL(NEW.Cantidad,0);
            END
